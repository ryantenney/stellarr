"""
Lightweight Web Push implementation. Cloud-agnostic.
No external dependencies beyond Python stdlib + cryptography.

Usage:
    from shared.webpush import send_push, generate_vapid_keys
