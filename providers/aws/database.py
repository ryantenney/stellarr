"""
Database operations using DynamoDB (AWS provider).
...
from providers.aws.dynamodb_lite import DynamoDBClient, ConditionalCheckFailedException

print("DEBUG: providers.aws.database loading (boto3-free)...", flush=True)
...
def mark_as_added(tmdb_id: int, media_type: str) -> dict | None:
    """Mark a request as added to Plex library. Returns the updated request or None."""
    try:
